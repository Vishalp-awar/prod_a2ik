...
// // Utility functions
// const apiUrl = "<%= env.BASE_URL %><%= env.PORT ? `:${env.PORT}` : '' %>";
...
//   await handleApiCall(`${apiUrl}${endpoint}`, event.target.method, data);
...
//   // Resources
//   document.getElementById("updateResourceForm").addEventListener("submit", (e) => handleFormSubmit(e, "/api/resources"));
//   document.getElementById("deleteArticleForm").addEventListener("submit", (e) => handleFormSubmit(e, "/api/resources"));

//   // Jobs
//   document.getElementById("updatejob").addEventListener("submit", (e) => handleFormSubmit(e, "/api/addjob"));
//   document.getElementById("deletejobForm").addEventListener("submit", (e) => handleFormSubmit(e, "/api/addjob"));
//   document.getElementById("addjobForm").addEventListener("submit", (e) => handleFormSubmit(e, "/api/addjob"));

//   // Job Boards
//   document.getElementById("addjobboardsform").addEventListener("submit", (e) => handleFormSubmit(e, "/api/jobboard"));
//   document.getElementById("updatepositionsform").addEventListener("submit", (e) => handleFormSubmit(e, "/api/jobboard"));
//   document.getElementById("deletejobboardsform").addEventListener("submit", (e) => handleFormSubmit(e, "/api/jobboard"));

//   // Logout
//   document.getElementById('logoutButton').addEventListener('click', async () => {
//     try {
//       await handleApiCall(`${apiUrl}/logout`, 'GET');
//       window.location.href = '/login';
//     } catch (error) {
...
//   const fetchAndRender = async (endpoint, renderFunction) => {
//     try {
//       const data = await handleApiCall(`${apiUrl}${endpoint}`, 'GET');
//       renderFunction(data);
//     } catch (error) {
...
//   // Initial data fetch
//   fetchAndRender('/api/applyjob', renderApplicants);
//   fetchAndRender('/api/contactus', renderContactSubmissions);

//   // UI toggle functions
//   const toggleFormVisibility = (formId, isVisible) => {
//     document.getElementById(formId).style.display = isVisible ? 'block' : 'none';
//   };

//   window.ArticletoggleForm = () => {
//     const option = document.getElementById("ArticleOption").value;
//     toggleFormVisibility("addnewArticle", option === "add");
//     toggleFormVisibility("updateResource", option === "update");
//     toggleFormVisibility("deleteArticle", option === "delete");
//   };

//   window.toggleForm = () => {
//     const option = document.getElementById("jobOption").value;
//     toggleFormVisibility("addjob", option === "add");
//     toggleFormVisibility("updatejobmain", option === "update");
//     toggleFormVisibility("deletejobContainer", option === "delete");
//   };

//   window.togglejobboardForm = () => {
//     const option = document.getElementById("jobboardOption").value;
//     toggleFormVisibility("addjobboards", option === "add");
//     toggleFormVisibility("updatejobboards", option === "update");
//     toggleFormVisibility("deletejobboards", option === "delete");
//   };
